"""This is the DIAL version of run experiment provided via HLE
Methods should be referenced by train.py"""

# TODO delete usueless imports
...
from DIAL import dial_HLE_agent
import gin.tf
...
@gin.configurable()
def create_agent(environment, obs_stacker, agent_type='DIAL'):
  ...
  """
    if agent_type == 'DIAL':
        return dial_HLE_agent.DIALAgent(observation_size=obs_stacker.observation_size(),
